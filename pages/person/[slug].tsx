...
const Person = ({
  ...
  console.log(groupedCredits, "credits");
    ...
    <div>
      ...
      >
        ...
        <div className="flex-1 flex flex-col self-stretch sm:max-w-lg md:max-w-2xl lg:max-w-4xl sm:ml-8">
          ...
          <div className="mt-4 flex flex-col space-y-2 border border-gray-500 rounded-md p-4">
...
export const getStaticProps: GetStaticProps = async (ctx) => {
  ...
  let groupedCredits = credits?.reduce((group: any, credit) => {
    let year;
  ...
  groupedCredits = Object.entries(groupedCredits).reverse();
